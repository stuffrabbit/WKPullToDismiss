...
public class WKPullToDismiss: NSObject {
    ...
    public let interactionController = WKPullToDismissInteractionController()
    ...
    /// The duration of the transition. Default is `0.5`.
    public var transitionDuration: TimeInterval = 0.5
    
    /**
     The single initializer. If you pass `UIScrollView` as `dismissView` parameter, the scrollviews `UIPanGestureRecognizer` will be used to trigger the dismissal. Otherwise, a new `UIPanGestureRecognizer` will be created and added to the `dismissal` view. Make sure that other gesture recognizers do not interfere.
...
extension WKPullToDismiss: UIViewControllerTransitioningDelegate {
    public func animationController(forDismissed dismissed: UIViewController) -> UIViewControllerAnimatedTransitioning? {
        return interactionController.started ? WKPullToDismissAnimationController(transitionDuration: transitionDuration) : nil
    }
...
public class WKPullToDismissAnimationController: NSObject, UIViewControllerAnimatedTransitioning {
...
public class WKPullToDismissInteractionController: UIPercentDrivenInteractiveTransition {
    /// Tells whether the transition has started or not. Do not modify this value.
